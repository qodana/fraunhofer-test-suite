...
public class TestNestedMap {
  public void test(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    response.getWriter()
      .println(map.get("key1a").get("key2b")); //Inspection: Uncontrolled user input is passed to Cross-Site Scripting (XSS) sink
    response.getWriter()
      .println(map.get("key2a").get("key1b")); //Inspection: Uncontrolled user input is passed to Cross-Site Scripting (XSS) sink
